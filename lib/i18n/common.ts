export const commonZhCN = {
  ...
  toolbar: {
    ...
    includeQuizOn: '包含检测题',
    includeQuizOff: '无检测题',
    includeQuizDesc: '在课程中插入检测题，用于学习效果评估',
    includeQuizHint: '切换是否生成检测题场景',
...
export const commonEnUS = {
  ...
  toolbar: {
    ...
    includeQuizOn: 'Include Quiz',
    includeQuizOff: 'No Quiz',
    includeQuizDesc: 'Insert quiz scenes into the course for assessment',
    includeQuizHint: 'Toggle quiz scene generation',
