...
export const settingsEnUS = {
  settings: {
    ...
    required: 'Required',
    agentNames: {
      'default-1': 'Training Director',
      'default-2': 'Instructional Designer',
      'default-3': 'Business Representative',
      'default-4': 'Learner Representative',
      'default-5': 'Course Strategist',
      'default-6': 'OD Consultant',
    },
    agentRoles: {
      teacher: 'Teacher',
      assistant: 'Assistant',
